...
const faqs = [
  { question: "Which is the best MBA HR college in Pune?", answer: "SCMHRD (NIRF #22) is the best MBA HR college in Pune â€” it has a dedicated HRD (Human Resource Development) specialization with Accenture, L&T, Mahindra, and Wipro as top HR recruiters at â‚¹14â€“19 LPA. SIBM Pune is #2 for MBA HR. PUMBA offers excellent HR MBA at â‚¹1.25L/yr." },
  { question: "What is the salary after MBA HR from Pune?", answer: "MBA HR placements in Pune: SCMHRD â‚¹14â€“19 LPA, SIBM â‚¹12â€“18 LPA, MIT-SOM â‚¹8â€“11 LPA, PUMBA â‚¹6â€“8.5 LPA. IT companies (TCS, Infosys, Wipro) in Pune are the biggest HR MBA recruiters. Senior HR/HRBP roles in Pune IT companies pay â‚¹15â€“30 LPA after 5 years." },
...
export default function MBAHR() {
  ...
  return (
    <>
      ...
      <MBAClusterPage
        h1="MBA in HR â€” Colleges in Pune 2026"
        ...
        quickAnswer="SCMHRD Pune (dedicated HRD specialisation, avg â‚¹14â€“19 LPA) is the best MBA HR college in Pune. SIBM and PUMBA follow. IT companies (TCS, Infosys, Wipro) in Pune are the biggest MBA HR recruiters. Admission via SNAP (Symbiosis) or MAH-CET MBA."
        stats={[
          { value: "8+", label: "MBA HR Colleges" },
          { value: "â‚¹6â€“19 LPA", label: "Placement Range" },
          { value: "IT/Manufacturing", label: "Top Sectors" },
          { value: "SNAP/MAH-CET", label: "Exams" },
        ]}
                colleges={mbaColleges.filter(c => c.specializations.includes("HR"))}
        introHeading="MBA HR in Pune â€” Scope & Career Opportunities"
        introParagraphs={[
          ...
          "Key HR roles post-MBA from Pune: HR Business Partner (â‚¹8â€“15 LPA), Talent Acquisition Manager (â‚¹8â€“14 LPA), L&D Manager (â‚¹9â€“14 LPA), Total Rewards Specialist (â‚¹10â€“18 LPA), HR Analytics Specialist (â‚¹10â€“20 LPA).",
        ]}
        faqs={faqs}
        internalLinks={[
        ...
        ctaHeading="MBA HR in Pune â€” Get Your College Shortlist"
