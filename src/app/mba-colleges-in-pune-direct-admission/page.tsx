...
const faqs = [
  { question: "Can I get MBA admission in Pune without MAH-CET?", answer: "Yes. MBA direct admission in Pune is possible through: (1) Management Quota seats (15-20% of intake) at private colleges â€” no MAH-CET required. (2) Institutional Quota at deemed universities (MIT-WPU, DYPIM) via direct application. (3) NRI/NRI-sponsored quota. (4) Spot admission rounds after CAP for vacant seats at lower-cutoff colleges." },
  { question: "What is the process for MBA direct admission in Pune?", answer: "MBA direct admission process in Pune: (1) Contact the college admission office directly. (2) Submit your graduation certificate, 10+2 marksheets, and any entrance score (optional). (3) Attend an interview (most colleges conduct GD-PI even for direct admission). (4) Pay the management quota fee (typically 1.5-2Ã— regular fees). (5) Complete document verification and enrollment." },
  { question: "What are the fees for MBA direct/management quota in Pune?", answer: "MBA management quota fees in Pune are typically 1.5â€“2Ã— the CAP (regular) fees. Examples: MIT-SOM CAP fees â‚¹7L (2yr), management quota â‚¹10â€“12L (2yr). DYPIM CAP â‚¹12L, management quota â‚¹15â€“18L. Management quota is usually not eligible for government scholarships." },
  ...
  return (
    <>
      ...
      <MBAClusterPage
        ...
        quickAnswer="MBA direct admission in Pune is available through management quota (15-20% seats) at private colleges. No MAH-CET required. MIT-SOM, DYPIM, BVIMR, Indira MBA all offer management quota. Fees are 1.5-2Ã— regular (CAP) fees. Degree is identical â€” fully valid."
        stats={[
          { value: "15â€“20%", label: "Management Quota" },
          { value: "No Exam", label: "MAH-CET Not Needed" },
          { value: "Same Degree", label: "Identical to CAP" },
          { value: "Aug 2026", label: "Classes Begin" },
        ]}
                colleges={mbaColleges.filter(c => c.type !== "Government")}
        introHeading="MBA Direct Admission in Pune â€” Everything You Need to Know"
        introParagraphs={[
          ...
          "Key advantage of direct admission: you can target the college you want regardless of MAH-CET score. Key disadvantage: you pay 1.5â€“2Ã— higher fees and are not eligible for government EBC/scholarship programs. Calculate ROI carefully â€” if placement outcomes are the same, the higher fee may be justified.",
        ]}
        faqs={faqs}
        internalLinks={[
        ...
        ctaSubtext="Our counsellors know which colleges have management quota seats available â€” free guidance."
      />
    </>
  )
}
