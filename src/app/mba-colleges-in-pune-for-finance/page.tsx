...
const faqs = [
  { question: "Which is the best MBA Finance college in Pune?", answer: "SIBM Pune is the best MBA Finance college in Pune â€” Goldman Sachs, Deutsche Bank, HSBC, JPMorgan recruit from SIBM for finance roles at â‚¹20â€“85 LPA. SCMHRD (NIRF #22) is #2 for Finance MBA. PUMBA offers the best value for Finance MBA at â‚¹1.25L/yr with banking and NBFC placements." },
  ...
  { question: "Is MBA Finance better than CA for a career in finance?", answer: "Both are excellent but different. CA is better for accounting, taxation, and audit careers. MBA Finance from a top Pune college (SIBM, SCMHRD) is better for investment banking, corporate finance, and management roles. Average starting salary: CA â‚¹7â€“12 LPA, MBA Finance (SIBM) â‚¹20â€“30 LPA. The combination of CA + MBA Finance gives the highest salary." },
  { question: "What is the average salary for MBA Finance from Pune?", answer: "MBA Finance placement: SIBM Pune â‚¹24 LPA avg (Finance stream highest), SCMHRD â‚¹19 LPA, PUMBA â‚¹8.5 LPA, MIT-SOM â‚¹10â€“12 LPA, DYPIM â‚¹8â€“9 LPA. Investment banking and corporate finance roles pay â‚¹20â€“85 LPA at top Pune MBA colleges." },
]
...
export default function MBAFinance() {
  ...
  return (
    <>
      ...
      <MBAClusterPage
        h1="MBA in Finance â€” Top Colleges in Pune 2026"
        subtitle="Best MBA Finance colleges in Pune â€” SIBM, SCMHRD, PUMBA with investment banking, BFSI and corporate finance placements."
        quickAnswer="SIBM Pune is the top MBA Finance college â€” Goldman Sachs, Deutsche Bank, JPMorgan recruit here (â‚¹20â€“85 LPA). SCMHRD is #2 (avg â‚¹19 LPA). PUMBA offers government MBA Finance at â‚¹1.25L/yr with banking sector placements."
        stats={[
          { value: "8+", label: "MBA Finance Colleges" },
          { value: "â‚¹8â€“24 LPA", label: "Avg Placement" },
          { value: "Banks/BFSI", label: "Top Sectors" },
          { value: "SNAP/CAT/MAH-CET", label: "Exams" },
        ]}
                colleges={mbaColleges.filter(c => c.specializations.includes("Finance"))}
        introHeading="MBA Finance in Pune â€” Why It's One of India's Best"
        introParagraphs={[
          ...
          "SIBM Pune stands apart for Finance MBA â€” it's the only Pune college where global investment banks (Goldman Sachs, Deutsche Bank, Barclays) conduct campus placement. This makes SIBM's Finance MBA comparable to IIM-level opportunities in terms of career outcomes.",
          "For students who cannot target SIBM/SCMHRD, PUMBA's Finance MBA (â‚¹1.25L total fees) and MIT-SOM's Finance MBA (â‚¹7L total) offer excellent placements in retail banking, corporate finance, and BFSI sector at â‚¹8â€“12 LPA starting packages.",
        ]}
        faqs={faqs}
        internalLinks={[
        ...
        ctaHeading="MBA Finance in Pune â€” Get Personalised Guidance"
